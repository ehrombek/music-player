...
// let curr_slider = document.querySelector('.current_time');
...
//         let currentSecondes = Math.floor(curr_track.currentTime - currentMinutes * 60);
//         let durationMinutes = Math.floor(curr_track.duration / 60);
//         let durationSecondes = Math.floor(curr_track.duration - durationMinuutes * 60);
...
//         curr_time.textContent = currentMinutes + ":" + currentSecondes;
